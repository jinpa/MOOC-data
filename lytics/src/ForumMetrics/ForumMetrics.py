...
class ForumMetrics(Controller):
    ...
    def loadContributions(self):
        ...
        for x in self.comments:
            try:
                commentsByUser.append(self.users.getByForum(x.forum_user_id))
            except KeyError:
                pass
    ...
    def loadData(self):
        ...
        self.views = ForumViewLog.objects.all()
        self.reputations = ForumReputationPoints.objects.all()
